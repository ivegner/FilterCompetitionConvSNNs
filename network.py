...
class Prototype1(Network):
    def __init__(
        self, n_input_channels, patch_shape, n_filters, n_l1_features, n_l2_features, dt=1
    ):
        """
        ...
        **Args:**
        ...
        position_layer = Input(2, traces=True)
    ...
    def run(self, x, time_per_patch):
        ...
        # x["encoded_positions"]: (batch_size, n_patches, time_per_patch, 2)
    ...
    def _make_patches(self, x, time_per_patch, patch_intensity=512, position_intensity=512):
        ...
        # TODO: investigate using 4 positions instead of 2
        ...
        # encoded_positions: (n_patches, time, 2)
        # add batch dimension
